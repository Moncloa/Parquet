...
- The risk gate defines desired exposure before leverage is chosen. Autonomous real sizing then selects the lowest broker-supported leverage that can express the greatest possible share of that risk-approved exposure within the configured capital bounds. Leverage must never increase exposure beyond the risk gate; it is a capital-efficiency mechanism, not a risk target.
